...
m = Map("3ginfo", translate("Konfiguracja 3ginfo"),
	translate("Panel konfiguracyjny dla aplikacji 3ginfo."))
...
pin = s:option(Value, "pincode", translate("Kod PIN dla SIM (opcjonalny}"))
pin.default = ""
